...
function Hero() {
  ...
  return (
  <section  className='hero flex justify-around p-5'>
...
Feel free to tweak it to better match your personal style and experiences!</p>

{/* Location */}
<div className='flex w-[300px] p-2 items-center gap-3 '>
